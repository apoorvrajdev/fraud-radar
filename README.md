...
- [ ] **3G** — Transaction detail with fraud-score breakdown (design in [`docs/adr/PHASE_3G_DESIGN.md`](docs/adr/PHASE_3G_DESIGN.md))
  ...
  - [ ] **3G-4** — Analyst decision form + analyst-id capture + README sync
