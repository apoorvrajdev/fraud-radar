...
- [ ] **4A** — Demo scope ADR (which pages/interactions the static demo must support; what's disabled vs Loom-only)
- [ ] **4B** — Snapshot export script (`scripts/export_demo_snapshot.py` dumps stats, transactions, details, alerts, audit rows to JSON)
